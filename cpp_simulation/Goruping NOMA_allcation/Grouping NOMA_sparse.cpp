            ...
            else
            {
                for(int i=0; i<nMTCD ; i++)
                {
                    if(MTCD_Table[i].RA_initate_RAO == Now_RAO && MTCD_Table[i].Preamble_number == each_RAO_Pre_index )
                    {
                        ...
                        else if (each_RAO_Premble[each_RAO_Pre_index] <= 3 && MTCD_Table[i].Preamble_number <= nGroup)
                        {
                        ...
                        else if (each_RAO_Premble[each_RAO_Pre_index] == 1 && MTCD_Table[i].Preamble_number > nGroup)
                        {
                            bool grant_check_index =0;
