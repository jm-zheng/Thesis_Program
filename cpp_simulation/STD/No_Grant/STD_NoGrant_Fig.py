...
CDF_MTCD = pd.read_csv(dircectory_nMTCD+"/stdsuccessdevice.csv")
...
plt.ylim(bottom=0)
plt.xlim(left=0)
plt.title('Preamble Status on each RAO for STD without Grant. nMTCD = '+dircectory_nMTCD,fontsize=22)
