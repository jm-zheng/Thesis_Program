...
int main()
{
    ...
    D2D_request_file.open("Dense\\with_earlydection\\"+directory_nMTCD+"\\Dense_with_earlydection_D2D_request.csv", fstream::out);
...
//--------確認發起RA後的狀態----------------------------------------------------------------------------------------
    ...
    nMTCD_file.open("Dense\\with_earlydection\\"+directory_nMTCD+"\\Dense_with_earlydection_RAtime.csv", fstream::out);
    if (nMTCD_file.is_open())
	{
        nMTCD_file <<"MTCD_number,group,D2D_first_request_RAO,D2D_initate_request_RAO,nRequest_D2D,";
    ...
    PreStatus_file.open("Dense\\with_earlydection\\"+directory_nMTCD+"\\Dense_with_earlydection_PreStatus.csv", fstream::out);
    ...
    SuccessMTCD_cumulation_file.open("Dense\\with_earlydection\\"+directory_nMTCD+"\\Dense_with_earlydection_SuccessMTCD.csv", fstream::out);
	...
	fstream result_file;
	result_file.open("Dense\\with_earlydection\\"+directory_nMTCD+"\\Dense_with_earlydection_result.txt",fstream :: out);
